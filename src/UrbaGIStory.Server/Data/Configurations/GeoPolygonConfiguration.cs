...
/// <summary>
/// Entity Framework configuration for GeoPolygon.
/// Configures the table as a QGIS-editable polygon layer.
/// </summary>
public class GeoPolygonConfiguration : IEntityTypeConfiguration<GeoPolygon>
{
    public void Configure(EntityTypeBuilder<GeoPolygon> builder)
    {
        builder.ToTable("geo_polygons");
        ...
        // Configure PostGIS Polygon geometry with SRID 4326 (WGS84)

...
/// <summary>
/// Entity Framework configuration for GeoPoint.
/// Configures the table as a QGIS-editable point layer.
/// </summary>
public class GeoPointConfiguration : IEntityTypeConfiguration<GeoPoint>
{
    public void Configure(EntityTypeBuilder<GeoPoint> builder)
    {
        ...
        // Configure PostGIS Point geometry with SRID 4326 (WGS84)

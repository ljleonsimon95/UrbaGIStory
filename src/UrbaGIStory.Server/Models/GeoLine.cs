...
/// <summary>
/// Represents a line geometry that can be edited in QGIS.
/// This table is designed to be a QGIS layer for line features (streets, facade lines, etc.).
/// </summary>
public class GeoLine
{
    ...
    /// <summary>
    /// The line geometry (PostGIS LINESTRING type).
    ...
    /// <summary>
    /// Entities that are linked to this line geometry.
    /// </summary>

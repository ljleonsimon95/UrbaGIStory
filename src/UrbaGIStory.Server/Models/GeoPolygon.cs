...
/// <summary>
/// Represents a polygon geometry that can be edited in QGIS.
/// This table is designed to be a QGIS layer for polygon features (buildings, blocks, plazas, etc.).
/// </summary>
public class GeoPolygon
{
    ...
    /// <summary>
    /// The polygon geometry (PostGIS POLYGON type).
    ...
    /// <summary>
    /// Entities that are linked to this polygon geometry.
    /// </summary>
